...
class BloodBaseScreen extends StatefulWidget {
  final Widget child;
  BloodBaseScreen({this.child});

  @override
  _BloodBaseScreenState createState() => _BloodBaseScreenState();
}

class _BloodBaseScreenState extends State<BloodBaseScreen> {
  @override
