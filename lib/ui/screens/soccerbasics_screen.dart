...
import 'package:challengers/ui/widgets/custom_circle_button.dart';
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: <Widget>[
                                    _warmupButton(Colors.black45, "3 min",
                                        'https://www.youtube.com/watch?v=HDfvWrGUkC8'),
                                    // _warmupButton(Colors.black45, "test", 'https://flutter.github.io/assets-for-api-docs/assets/videos/butterfly.mp4'),
                                    _warmupButton(Colors.black, "12 min",
                                        'https://www.youtube.com/watch?v=iqbbwFYXjFc&t=617s'),
                                  ],
                                ),
                              ],
                            ),
                      ...
                      child: new Container(
                        child: new Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              "Turn on the music and get ready to start your workout.",
