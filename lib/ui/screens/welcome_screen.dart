        ...
        body: new ListView(
          children: <Widget>[
            Padding(
              ...
              child: new Container(
                height: 80.0,
                child: new Image.asset('assets/images/ball.png',
            ...
            Padding(
              padding:
                  const EdgeInsets.only(top: 100.0, right: 15.0, left: 15.0),
