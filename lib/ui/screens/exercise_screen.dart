...
import 'package:challengers/ui/widgets/custom_flat_button.dart';
...
class _ExerciseState extends State<Exercise> {
  ...
  void initState() {
    ...
    Firestore.instance.collection('exercise1').orderBy('no').snapshots().listen(
        (data) => data.documents.forEach((doc) => _exerciseData.add(doc)));
      ...
      (Timer timer) => setState(
        () {
          ...
          if (_trainingcheck == 0) {
            ...
            if (_start ==
                (int.parse(_exerciseData[_exerciseNum]['durationTime']) / 2)
                    .round()) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: new IconButton(
            icon: new Icon(Icons.arrow_back), onPressed: () => backPress()),
        title: Text(
          _exerciseTitle,
      ...
      body: SlidingUpPanel(
        ...
        panel: new Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: Colors.black.withOpacity(0.6), spreadRadius: 2000),
              ],
            ),
          ...
          child: new Container(
            child: new Column(
              children: <Widget>[
                ...
                Text(
                  "Going back will restart the",
                  style: TextStyle(fontSize: 18.0),
                ),
                Text(
                  "timer. Are you sure you",
                  style: TextStyle(fontSize: 18.0),
                ),
                Text(
                  "want to do this?",
